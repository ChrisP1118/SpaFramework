...
{
    public class ContentBlockService : EntityWriteService<ContentBlock, long>
    {
        ...
        protected override async Task<IQueryable<ContentBlock>> ApplyIdFilter(IQueryable<ContentBlock> queryable, long id)
        {
