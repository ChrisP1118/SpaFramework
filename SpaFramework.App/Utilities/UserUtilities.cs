...
namespace SpaFramework.App.Utilities
{
    public static class UserUtilities
    {
        ...
        public static long GetUserIdAsLong(this ClaimsPrincipal claimsPrincipal)
        {
            ...
            long x;
            if (long.TryParse(claim.Value, out x))
                return x;
        ...
        {
            long applicationUserId = configuration.GetValue<long>("DefaultWorkItemUserId");
